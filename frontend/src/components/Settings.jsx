      ...
      <div className="card">
        <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
          <div className="flex items-center gap-3">
            <AcademicCapIcon className="h-5 w-5 text-maroon-600" />
            <h2 className="text-lg font-semibold text-gray-900">LMS Setup</h2>
          </div>
        </div>
        <div className="p-6 bg-white">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-700 font-medium">Sakai LMS Configuration</p>
              <p className="text-sm text-gray-500">Edit your Sakai credentials, courses, files, and tab preferences</p>
            </div>
            <button
